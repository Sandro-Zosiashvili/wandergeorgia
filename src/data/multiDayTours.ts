...
export const multiDayTours: Tour[] = [
    {
        ...
        itinerary: [
            ...
            },
            {
                ...
                description:
                    'Long-distance transfer from Kazbegi to Batumi with a relaxing lunch stop along the way. Overnight stay in Batumi.',
    ...
    },
    {
        ...
        locations: [
            ...
            {
                name: 'Day 2 — Tbilisi & Kazbegi',
                description:
                    'Travel along the scenic Georgian Military Highway, stopping at Zhinvali Reservoir, Ananuri Fortress, and the iconic Gudauri Panorama before reaching Kazbegi to visit the famous Gergeti Trinity Church. Overnight stay in Kazbegi.',
            },
            {
                name: 'Day 3 — Kakheti',
                description:
                    'Explore Sighnaghi, visit the serene Bodbe Monastery, walk the ancient fortress walls, and enjoy authentic Georgian wine tastings at KTW Winery.',
            },
        ],
        itinerary: [
            {
            ...
            },
            {
                ...
                highlights: [
                    ...
                    "Gudauri Panorama (Gudauri Friendship Monument)",
    ...
    },
    {
        ...
        locations: [
            ...
            {
                name: 'Day 3 — Tbilisi & Kazbegi',
                description:
                    'Travel along the scenic Georgian Military Highway, stopping at Zhinvali Reservoir, Ananuri Fortress, and the iconic Gudauri Panorama before reaching Kazbegi to visit the famous Gergeti Trinity Church. Overnight stay in Kazbegi.',
            },
            {
                name: 'Day 4 — Kazbegi & Tbilisi',
                description:
                    'Visit the magnificent Dariali Monastery near the border, then journey back to explore UNESCO World Heritage sites in Mtskheta — Jvari Monastery and Svetitskhoveli Cathedral — before returning to Tbilisi.',
            },
            {
